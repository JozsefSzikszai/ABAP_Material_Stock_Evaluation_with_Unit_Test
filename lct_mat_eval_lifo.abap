...
CLASS lct_mat_eval_lifo DEFINITION FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
...
ENDCLASS.       "lct_Mat_Eval_Lifo


CLASS lct_mat_eval_lifo IMPLEMENTATION.
  ...
  METHOD evaluate_1.
    ...
    TRY.
        DATA(lo_cut) = zcl_mat_eval_factory=>create( iv_evaluation_type = 'LIFO'
  ...
  METHOD evaluate_3.
    ...
    DATA(lt_expected) = VALUE zif_mat_eval=>tt_result(
      ( datum = '20260101' menge = '3' meins = 'ST' dmbtr = '10.00' waers = 'EUR' ) ).
